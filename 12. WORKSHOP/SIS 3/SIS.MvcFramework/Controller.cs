...
namespace SIS.MvcFramework
{
    public abstract class Controller
    {
        ...
        protected void SignIn(string userId)//, string username = null)
        {
            Request.SessionData["UserId"] = userId;
          //Request.SessionData["Username"] = username;
        }
        ...
        //public string Username => Request.SessionData.ContainsKey("Username") ? Request.SessionData["Username"] : null;
    }
}
